...
Write-Host "Version: v3.3.3" -ForegroundColor Green
Write-Host ""
...
python -m pip install --upgrade --quiet "spotwarp>=3.3.3"

# 2. Check installation
$spotwarpCmd = Get-Command spotwarp -ErrorAction SilentlyContinue
if ($spotwarpCmd) {
    Write-Host "[+] Successfully installed spotwarp v3.3.3!" -ForegroundColor Green
} else {
