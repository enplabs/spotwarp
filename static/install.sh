...
echo -e "Version: ${GREEN}v3.4.0${RESET}\n"
...
python3 -m pip install --upgrade --quiet spotwarp>=3.4.0

# 2. Verify CLI installation
if command -v spotwarp &> /dev/null; then
    echo -e "${GREEN}[+] Successfully installed spotwarp $(spotwarp --version 2>/dev/null || echo '3.4.0')!${RESET}"
else
